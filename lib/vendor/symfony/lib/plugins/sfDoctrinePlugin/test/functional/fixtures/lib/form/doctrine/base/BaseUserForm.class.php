...
abstract class BaseUserForm extends BaseFormDoctrine
{
  ...
  {
    $this->object->removeReference('UserGroup');
    $this->object->removeReference('Groups');
    $this->saveGroupsList($con);
    $this->object->removeReference('UserPermission');
    $this->object->removeReference('Permissions');
