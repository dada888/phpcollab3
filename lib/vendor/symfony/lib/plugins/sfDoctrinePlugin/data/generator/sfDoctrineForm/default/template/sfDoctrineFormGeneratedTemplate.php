...
<?php /* (start) by Jonathan Wage */?>
<?php foreach ($this->getManyToManyRelations() as $relation): ?>
    $this->object->removeReference('<?php echo $relation['refTable']->getOption('name') ?>');
    $this->object->removeReference('<?php echo $relation->getAlias() ?>');

<?php endforeach; ?>
<?php /* (end) by Jonathan Wage */?>
