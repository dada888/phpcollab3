  ...
  <div class="span-full">
    ...
    <div class="span-full">
      <div class="highlight last-row">
        <div class="span-half">
          <div class="span-full">
            <label><strong class="red">Name</strong></label>
            <br />
          ...
          <div class="span-full">
            <label><strong class="red">Project</strong></label>
            <br />
          ...
          <div class="span-full">
            <label><strong class="red">Description</strong></label>
            <br />
        ...
        <div class="span-half">
          <div class="span-full">
            <label><strong class="red">Date</strong></label>
            <br />
            <img src="images/temp-cal.jpg" alt="Cal" width="108" height="19" /></div>
          <div class="span-full">
            <label><span class="red"><strong>How long did you take?</strong></span></label>
            <br />
      ...
      <ul class="action time">
        <li class="icon-time">
          <ul>
            ...
            <li class="right"><a href="index.php?page=projects-open">The New Acme Project</a></li>
