...
$browser->
  ...
  with('response')->begin()->
    checkElement('.project-navigation ul li a[href*="en/idProject/show/3"]', 'Il mio terzo progetto', array('position' => 0))->
    checkElement('.project-navigation ul li a', 'Files', array('position' => 4))->
    ...
    checkElement('.project-navigation ul li a', 'Settings', array('position' => 7))->
  end();
