...
//$browser->test()->fail("\n\nWARNING: Likely a bug for functional testing!\nWith \"test browser\" the form returns a http 500 status.\nWith \"real browser\" the page is loaded correctly and perfomes the creation of a new user.\n\n");
