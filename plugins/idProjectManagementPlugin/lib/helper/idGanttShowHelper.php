...
function retriveSwfUrl()
{
  ...
  if ($env == 'demo')
  {
    return '/demo/idProjectManagementPlugin/Charts/FCF_Gantt.swf';
  }

  if ($env == 'phpcollabdev')
  {
    return '/phpcollab_dev/idProjectManagementPlugin/Charts/FCF_Gantt.swf';
  }

  return '/idProjectManagementPlugin/Charts/FCF_Gantt.swf';
}
