...
<?php endif; ?>
  ...
  <?php endif; ?>
      ...
      <div class="group">
        ...
        <?php endif; ?>
        <?php echo $form['users_list']->renderLabel(__('User(s) of this project'), null, array('class'=>'label')) ?>
      ...
      <div class="group navform">
        ...
        &nbsp;<a href="<?php echo url_for('@index_project') ?>">Go back to the project list</a> or
        <input type="submit" value="<?php echo $form->getObject()->isNew() ? __('Create a new project') : __('Update the project') ?>" />
      </div>
</form>