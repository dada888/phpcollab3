          ...
          <?php else: ?>
            <?php foreach ($status_list as $status): ?>
              <tr class="odd">
                ...
                <td><?php echo link_to(__('Edit'), '@edit_status?id='.$status->getId()) ?> | <?php echo link_to(__('Delete'), '@delete_status?id='.$status->getId(), array('confirm' => __('Do you really want to delete this status?'))) ?></td>
                <td>&nbsp;</td>
              </tr>
            <?php endforeach; ?>
          <?php endif; ?>
